...
tags: [tools]
thumbnail-img: "/resources/ep053-use-fastlane-to-create-prs/thumbnail.webp"
readtime: true
---
...
6. Also additionally, you could add some documentation to your Contributing guidelines:
    ...
    2. [Here](https://github.com/mdb1/best-practices-example/blob/main/.github/docs/git/PRConventions.md) you can find some inspiration.
