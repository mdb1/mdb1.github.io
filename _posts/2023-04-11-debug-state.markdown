...
tags: [iOS, testing]
thumbnail-img: "/resources/ep33-view-state-debug/thumbnail.png"
---
...
<video style="width: 70%; @media (max-width: 768px) { width: 50%; }" controls>
    <source src="{{static.static_files}}/resources/ep33-view-state-debug/debug-state.mp4" type="video/mp4">
</video>
...
If you're interested in learning more about ViewStateController, be sure to check out the [ViewStateController post](/2023-03-04-view-state-controller/). 

---

## Featured in

- [Not Only Swift #38](https://not-only-swift.peterfriese.dev/issues/38)
