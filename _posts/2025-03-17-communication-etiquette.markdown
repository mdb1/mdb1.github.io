...
![no-hello]({{static.static_files}}/resources/ep079-communication-etiquette/no-hello.png)
...
![thread-police]({{static.static_files}}/resources/ep079-communication-etiquette/thread-police.gif)
