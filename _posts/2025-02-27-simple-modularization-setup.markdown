...
![dependency-diagram]({{static.static_files}}/resources/ep075-simple-modularization-setup/diagram.png)
...
![tests]({{static.static_files}}/resources/ep075-simple-modularization-setup/tests.png)
...
![xcode-proj]({{static.static_files}}/resources/ep075-simple-modularization-setup/xcode-proj.png)

This is how the `Presentation` package looks like:

![presentation-package]({{static.static_files}}/resources/ep075-simple-modularization-setup/presentation-package.png)

This is how the `Domain` package looks like:

![domain-package]({{static.static_files}}/resources/ep075-simple-modularization-setup/domain-package.png)

And the folder structure:

![folder-structure]({{static.static_files}}/resources/ep075-simple-modularization-setup/folder-structure.png)
