...
![diagram]({{static.static_files}}/resources/ep057-combine-based-repository/diagram.png)
...
<video style="width: 70%; @media (max-width: 768px) { width: 50%; }" controls>
    <source src="{{static.static_files}}/resources/ep057-combine-based-repository/demo.mp4" type="video/mp4">
</video>
...
<video style="width: 70%; @media (max-width: 768px) { width: 50%; }" controls>
    <source src="{{static.static_files}}/resources/ep057-combine-based-repository/optimistic+error.mp4" type="video/mp4">
</video>
