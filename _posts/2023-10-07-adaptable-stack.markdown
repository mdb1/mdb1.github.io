...
![Adaptable]({{static.static_files}}/resources/ep063-adaptable-stack/adaptable.png)

### Demo:

<video style="width: 70%; @media (max-width: 768px) { width: 50%; }" controls>
    <source src="{{static.static_files}}/resources/ep063-adaptable-stack/demo.mp4" type="video/mp4">
</video>
...
![Non-Adaptable]({{static.static_files}}/resources/ep063-adaptable-stack/fixed.png)
