...
![metadata]({{static.static_files}}/resources/ep071-new-app-os-log/metadata.png)

![logs]({{static.static_files}}/resources/ep071-new-app-os-log/logs.png)

You can also go directly to the line of code that produced the log:

![jump-to-line]({{static.static_files}}/resources/ep071-new-app-os-log/jump.png)

The filters are also great:

![filters]({{static.static_files}}/resources/ep071-new-app-os-log/filters.png)
